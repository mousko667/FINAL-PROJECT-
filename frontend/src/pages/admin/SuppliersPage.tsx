          ...
          <>
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b">
                <tr>
                  <th className="text-left px-4 py-3 font-medium text-gray-600">{t('supplier.fields.companyName', 'Company Name')}</th>
                ...
                {(!data?.content || data.content.length === 0) ? (
                  ...
                  data.content.map((supplier) => (
                    <tr key={supplier.id} className="hover:bg-gray-50 group">
                      ...
                      <td className="px-4 py-3 text-gray-500">{supplier.taxId}</td>
